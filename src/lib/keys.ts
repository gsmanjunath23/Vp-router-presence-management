...
// PRESENCE
const PRESENCE_USER_KEY_FORMAT = "presence:user:%s";
const PRESENCE_META_KEY_FORMAT = "presence:meta:%s";
...
export class Keys {
  ...
  public static forPresence(userId: numberOrString): string {
    return util.format(PRESENCE_USER_KEY_FORMAT, userId);
  }

  public static forPresenceMeta(userId: numberOrString): string {
    return util.format(PRESENCE_META_KEY_FORMAT, userId);
  }
